...
class CENTER_MODEL(object):
    ...
    def detect_obj(self, img,  show=False, save_res=False):
        ...
        if show:
            ...
            if len(qh_box) > 0:
                img_draw = cv2.circle(img_draw, (qh_box[0][0], qh_box[0][1]), radius=2, color=colors['blue'], thickness=2)
...
if __name__ == "__main__":
    ...
    parser.add_argument("--image_path", type=str, default='C:\\Users\\hoanglv10\\PycharmProjects\\Object_Corner_Detection\\demo\\cmnd_hoang.jpg')
    ...
    model.detect_obj(img, show=True, save_res=True)
